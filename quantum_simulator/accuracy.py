...
filename1 = 'accuracy1.txt'
filename2 = 'accuracy2.txt'
...
if x1 and y1:  # Убедимся, что x и y не пустые
    ...
    plt.title('Зависимость точности от среднего квадратичного отклонения', fontweight='bold', fontsize=30)

    plt.xticks(fontsize=23, fontweight='bold') #Поворачиваем названия состояний для читаемости
    ...
    plt.savefig('accuracy.png') # Сохраняет график в файл
